...
- We mainly rely on Chrome's `Performance` tab to analyse and record the performance of MDComment
...
- Simply go to `Performance`, press `Record`, and wait for MDComment to launch fully, then Stop the recording
