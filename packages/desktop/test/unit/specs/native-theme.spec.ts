...
describe('Native theme source', () => {
  ...
  it('uses dark native menus for dark MDComment themes', () => {
  ...
  it('uses the shared MDComment dark theme classification', () => {
  ...
  it('uses light native menus for light MDComment themes', () => {
